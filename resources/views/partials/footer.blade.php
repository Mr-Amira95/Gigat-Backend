    ...
    <footer
        ...
        <div class="container">
            <span class="text-gray dark:text-defaulttextcolor/50"> Copyright © <span id="year"></span> <a
                    ...
                    class="text-defaulttextcolor font-semibold dark:text-defaulttextcolor">Gigat</a>.
                Designed by <a target="_blank" href="https://smartedge.me">
                    <span class="font-semibold text-primary underline">Smartedge Soluations</span>
                </a> All
                rights
                reserved
            </span>
