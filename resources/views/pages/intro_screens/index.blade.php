...
@section('title', __('mobile_intro_screens'))
@push('styles')
    ...
    <div class="content">
        <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="text-[1.125rem] font-semibold">{{ __('mobile_intro_screens') }}</h3>
                </div>
                <ol class="flex items-center whitespace-nowrap">
                    ...
                    <li class="text-[0.813rem] font-semibold">{{ __('mobile_intro_screens') }}</li>
                </ol>
            </div>
        </div>
        <div class="container">
                ...
                <div class="col-span-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            @can('create_sliders')
                                <a href="{{ route('sliders.createMobileSliders') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="flex items-center gap-1 justify-center">
                                                            <a href="{{ route('sliders.moveUp', $slider->id) }}"
                                                                class="ti-btn ti-btn-icon ti-btn-sm ti-btn-warning rounded-pill"
                                                                title="{{ __('move_up') }}">
                                                                <i class="las la-arrow-up"></i>
                                                            </a>
                                                            <a href="{{ route('sliders.moveDown', $slider->id) }}"
                                                                class="ti-btn ti-btn-icon ti-btn-sm ti-btn-info rounded-pill"
                                                                title="{{ __('move_down') }}">
                                                    ...
                                                    <td>
                                                        ...
                                                        @can('edit_sliders')
                                                            <a aria-label="anchor"
                                                                href="{{ route('sliders.editMobileSliders', $slider->id) }}"
