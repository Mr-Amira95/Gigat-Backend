            ...
            <div class="block justify-between page-header md:flex items-center mb-4 p-4">
                ...
                <ol class="flex items-center whitespace-nowrap text-sm text-gray-600">
                    <li class="text-[0.813rem] ps-[0.5rem]">
                        <a class="flex items-center text-primary hover:text-primary" href="{{ route('sliders.mobileSliders') }}">
                            {{ __('sliders') }}
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                        <label class="block text-sm font-medium text-gray-700 mb-1">
                                            <i class="fas fa-desktop text-gray-400 mr-1"></i> {{ __('platform') }}
                                        </label>
                                        <p class="text-gray-800 font-semibold capitalize">{{ $slider->platform }}</p>
                                    </div>
                                    <div class="bg-white p-4 rounded-lg shadow-sm">
                                        <label class="block text-sm font-medium text-gray-700 mb-1">
                                        ...
                                        <p class="text-gray-800">
                                            <span class="px-2 py-1 rounded-full text-xs {{ $slider->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
