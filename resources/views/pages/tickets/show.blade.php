        ...
        <div class="main-content">
            ...
            <div class="box">
                <div class="box-header">
                    <h5 class="box-title">{{ __('ticket_details') }}</h5>
                </div>
                <div class="box-body">
                            ...
                            <form action="{{ route('tickets.changeStatus', $ticket->id) }}" method="POST" class="mt-2">
                                ...
                                @can('close_tickets')
                                    <button type="submit"
                                        ...
                                        {{ $ticket->status === 'open' ? __('close_ticket') : __('open_ticket') }}
                                    </button>
                                @endcan
                            </form>
                        </div>
            ...
            <div class="box">
                <div class="box-header">
                    <h5 class="box-title">{{ __('ticket_messages') }}</h5>
                </div>
                <div class="box-body">
            ...
            @can('reply_tickets')
                <div class="box">
                    <div class="box-header">
                        <h5 class="box-title">{{ __('reply_to_ticket') }}</h5>
                    </div>
                    <div class="box-body">
                        <form action="{{ route('tickets.reply', $ticket->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="message"
                                        class="block text-sm font-medium text-gray-700">{{ __('your_reply') }}</label>
                                ...
                                <div>
                                    <label for="attachment"
                                        class="block text-sm font-medium text-gray-700">{{ __('attach_files') }}</label>
                                ...
                                <div class="flex justify-end">
                                    <button type="submit"
                                        ...
                                        {{ __('send_reply') }} <i class="las la-paper-plane text-lg"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
