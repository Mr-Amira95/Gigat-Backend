...
@section('title', __('create_release'))
    ...
    <div class="content">
        <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="text-[1.125rem] font-semibold">{{ __('create_release') }}</h3>
                </div>
                <ol class="flex items-center whitespace-nowrap">
                    ...
                    <li class="text-[0.813rem] font-semibold">{{ __('create_release') }}</li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-span-12">
                    <div class="box">
                        <div class="box-header">
                            <h5 class="box-title">{{ __('create_release') }}</h5>
                        </div>
                        <div class="box-body">
                            <form action="{{ route('admin.releases.store') }}" method="POST">
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    ...
                                    <div class="col-span-12 md:col-span-4">
                                        ...
                                        <input type="text" name="android_version" value="{{ old('android_version') }}"
                                    ...
                                    <div class="col-span-12 md:col-span-4">
                                        ...
                                        <input type="text" name="ios_version" value="{{ old('ios_version') }}"
                                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                                    </div>
                                    ...
                                    <div class="col-span-12 md:col-span-4">
                                        ...
                                        <input type="text" name="web_version" value="{{ old('web_version') }}"
                                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                                    </div>
                                    ...
                                    {{-- <div class="col-span-12">
                                        ...
                                        <textarea name="release_note" id="release_note"
                                            class="summernote mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">{{ old('release_note') }}</textarea>
                                        @error('release_note')
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <textarea name="release_note_en" id="release_note_en"
                                            class="summernote mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">{{ old('release_note_en') }}</textarea>
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <textarea name="release_note_ar" id="release_note_ar"
                                            ...
                                            dir="rtl">{{ old('release_note_ar') }}</textarea>
