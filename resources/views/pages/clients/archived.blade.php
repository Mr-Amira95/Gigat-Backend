...
@section('title', __('archived_clients'))
@push('styles')
    ...
    <div class="content">
        <div class="main-content">
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="text-[1.125rem] font-semibold">{{ __('archived_clients') }}</h3>
                </div>
                <ol class="flex items-center whitespace-nowrap">
                    ...
                    <li class="text-[0.813rem] font-semibold">{{ __('archived_clients') }}</li>
                </ol>
            </div>
        </div>
        <div class="container">
                ...
                <div class="col-span-12">
                    <div class="box">
                        <div class="box-header">
                            <h5 class="box-title">{{ __('archived_clients') }}</h5>
                        </div>
                        <div class="box-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    onclick="showRestoreConfirmation('{{ __('are_you_sure_restore') }}', {{ $client->id }})"
                                                    class="ti-btn btn-wave ti-btn-icon ti-btn-sm ti-btn-success mx-1 rounded-pill">
                                                    <i class="las la-undo"></i>
                                                </a>
                                                <form id="restore-form-{{ $client->id }}"
                                                    action="{{ route('clients.restore', $client->id) }}" method="POST"
                                                    class="hidden">
                                                    @csrf
                                                </form>
                                            </td>
