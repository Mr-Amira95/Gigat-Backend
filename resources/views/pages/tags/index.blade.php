                    ...
                    <div class="box">
                        ...
                        <div class="box-footer border-t p-4" style="display: none;">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <select id="category-filter" class="w-48 px-2 py-2 mt-1 block rounded-lg border-gray-300 text-gray-500">
                                ...
                                <select id="subcategory-filter" class="w-48 px-2 py-2 mt-1 block rounded-lg border-gray-300 text-gray-500">
