            ...
            <div class="block justify-between page-header md:flex">
                ...
                <ol class="flex items-center whitespace-nowrap">
                    <li class="text-[0.813rem] ps-[0.5rem]">
                        <a class="flex items-center text-primary hover:text-primary" href="{{ route('sliders.webSliders') }}">
                            {{ __('sliders') }}
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form action="{{ route('sliders.updateWebSlider', $slider->id) }}" method="POST"
                                    ...
                                    <div class="grid grid-cols-12 gap-4">
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="button_text_en"
                                                        value="{{ $slider->translations->where('language', 'en')->first()?->button_text }}"
                                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                                                </div>
                                                <div>
                                                    <label
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="button_text_ar"
                                                        value="{{ $slider->translations->where('language', 'ar')->first()?->button_text }}"
                                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                                                </div>
                                                <div>
                                                    <label
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <input type="text" name="button_action" value="{{ $slider->button_action }}"
                                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                                        </div>
                                    </div>
