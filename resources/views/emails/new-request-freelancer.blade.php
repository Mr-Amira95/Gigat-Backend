...
<head>
    <meta charset="UTF-8">
    <title>New Request on Gigat</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="color:#111827; font-size:18px; font-weight:600; padding-bottom:15px;">
                            Hi {{ $request->service->user->username }},
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="color:#374151; font-size:15px; line-height:1.7; padding-bottom:25px;">
                            Woow! You have received a new request on <strong>Gigat</strong>.
                    ...
                    <tr>
                        <td>
                            <table width="100%" cellpadding="10" cellspacing="0"
                                ...
                                <tr style="background:#f9fafb;">
                                    <td style="border:1px solid #e5e7eb;"><strong>Client</strong></td>
                                    <td style="border:1px solid #e5e7eb;">
